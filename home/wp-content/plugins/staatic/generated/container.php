...
class CachedContainer extends Container
{
    ...
    public function getRemovedIds(): array
    {
        return [
            ...
            'Staatic\WordPress\Cli\DeleteCommand' => \true,
            ...
            'Staatic\WordPress\Module\Admin\Page\Publications\PublicationTypeColumn' => \true,
    ...
    {
        $a = $this->services['staatic.publication_repository'] ?? $this->getStaatic_PublicationRepositoryService();
        $b = $this->services['staatic.logger'] ?? $this->getStaatic_LoggerService();
        $c = $this->privates['Staatic\WordPress\Service\Formatter'] = $this->privates['Staatic\WordPress\Service\Formatter'] ?? new Formatter();
